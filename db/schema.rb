...
ActiveRecord::Schema.define(version: 2022_02_03_111915) do
  ...
  create_table "elements", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["song_id"], name: "index_elements_on_song_id"
  end
  ...
  create_table "songs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["writer_id"], name: "index_songs_on_writer_id"
  end
  ...
  add_foreign_key "elements", "songs"
